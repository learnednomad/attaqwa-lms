...
export interface ApiAchievementAchievement extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Achievements and badges that students can earn';
  ...
  attributes: {
    achievement_type: Schema.Attribute.Enumeration<
      [
        'course_completion',
        'quiz_mastery',
        'streak',
...
export interface ApiCourseEnrollmentCourseEnrollment
  ...
  info: {
    description: 'Track student enrollments in courses';
  ...
  attributes: {
    average_quiz_score: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    enrollment_date: Schema.Attribute.DateTime & Schema.Attribute.Required;
    ...
    lessons_completed: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
    ...
    overall_progress: Schema.Attribute.Integer &
      ...
      Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    quizzes_completed: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    total_time_spent_minutes: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Educational courses for Islamic learning';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
  ...
  attributes: {
    age_tier: Schema.Attribute.Enumeration<
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    current_enrollments: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    learning_outcomes: Schema.Attribute.JSON;
...
export interface ApiLeaderboardLeaderboard extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Track user rankings and points';
  ...
  attributes: {
    achievements_earned: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
    ...
    average_quiz_score: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    courses_completed: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
    ...
    rank: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    total_points: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Individual lessons within courses with flexible content types';
    displayName: 'Lesson';
    pluralName: 'lessons';
    singularName: 'lesson';
  };
  ...
  attributes: {
    ...
    duration_minutes: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    interactive_content: Schema.Attribute.JSON;
    is_free: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    is_preview: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    learning_objectives: Schema.Attribute.JSON;
    lesson_order: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    lesson_type: Schema.Attribute.Enumeration<
      ['video', 'reading', 'interactive', 'quiz', 'practice']
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Quizzes for assessing student knowledge';
    displayName: 'Quiz';
    pluralName: 'quizzes';
    singularName: 'quiz';
  };
  ...
  attributes: {
    ...
    quiz_type: Schema.Attribute.Enumeration<
      ['practice', 'assessment', 'final']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'practice'>;
    randomize_questions: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    show_correct_answers: Schema.Attribute.Boolean &
...
export interface ApiStreakStreak extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Track daily learning streaks for users';
    displayName: 'Streak';
    pluralName: 'streaks';
    singularName: 'streak';
  };
  ...
  attributes: {
    ...
    current_streak: Schema.Attribute.Integer &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    freeze_count: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
    ...
    longest_streak: Schema.Attribute.Integer &
      ...
      Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    streak_frozen: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    streak_history: Schema.Attribute.JSON;
    streak_start_date: Schema.Attribute.Date;
    total_days_active: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiUserAchievementUserAchievement
  ...
  info: {
    description: 'Track achievements earned by users';
  ...
  attributes: {
    achievement: Schema.Attribute.Relation<
      ...
      'api::achievement.achievement'
    >;
    completion_data: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    earned_date: Schema.Attribute.DateTime & Schema.Attribute.Required;
...
export interface ApiUserProgressUserProgress
  ...
  info: {
    description: 'Track user progress through lessons and quizzes';
  ...
  attributes: {
    bookmarks: Schema.Attribute.JSON;
    ...
    quiz_attempts: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    quiz_score: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
