/**
 * Seed templates — pure data, no Strapi / HTTP coupling.
 *
 * Used by:
 *   - apps/api/scripts/seed/seed-bootstrap.ts  (HTTP, CI + manual)
 *
 * Previously inlined in apps/api/src/bootstrap.ts; extracted so the same
 * templates can drive both the embedded-Strapi auto-seed (dev) and the
 * HTTP-based standalone seed (CI / production-mode local).
 */
...
export const COURSES: CourseTemplate[] = [
  {
    ...
    description:
      'An engaging introduction to the Holy Quran designed specifically for children. Learn beautiful short Surahs from Juz 30 with simple explanations and audio recitations.',
    age_tier: 'children',
    subject: 'quran',
    difficulty: 'beginner',
    duration_weeks: 12,
  ...
  },
  {
    ...
    description:
      'Fun and interactive course teaching children the Arabic alphabet through games, songs, and colorful activities.',
    age_tier: 'children',
    subject: 'arabic',
    difficulty: 'beginner',
    duration_weeks: 8,
  ...
  },
  {
    ...
    description:
      'Captivating stories from the lives of prophets, teaching moral values and Islamic lessons through engaging narratives.',
    age_tier: 'children',
    subject: 'seerah',
    difficulty: 'beginner',
    duration_weeks: 16,
  ...
  },
  {
    ...
    description:
      'Comprehensive journey through the entire Quran with clear English translations and contextual understanding. Study all 114 Surahs systematically.',
    age_tier: 'youth',
    subject: 'quran',
    difficulty: 'beginner',
    duration_weeks: 52,
  ...
  },
  {
    ...
    description:
      'Master the rules of Quranic recitation with proper pronunciation, makharij, and beautification techniques.',
    age_tier: 'youth',
    subject: 'tajweed',
  ...
  },
  {
    ...
    description:
      'Learn Classical Arabic grammar (Nahw and Sarf) to understand Quranic Arabic and read Islamic texts with confidence.',
    age_tier: 'youth',
    subject: 'arabic',
    difficulty: 'intermediate',
    duration_weeks: 24,
  ...
  },
  {
    ...
    description:
      'Detailed study of Islamic jurisprudence covering prayer, fasting, zakat, and hajj according to authentic sources.',
    age_tier: 'adults',
    subject: 'fiqh',
    difficulty: 'intermediate',
    duration_weeks: 30,
  ...
  },
  {
    ...
    description:
      "In-depth study of Imam Nawawi's 40 Hadith collection, covering fundamental Islamic principles and prophetic wisdom.",
    age_tier: 'adults',
    subject: 'hadith',
    difficulty: 'intermediate',
    duration_weeks: 20,
  ...
  },
  {
    ...
    description:
      'Comprehensive study of Islamic belief system, pillars of faith, and protection from innovations in religion.',
    age_tier: 'adults',
    subject: 'aqeedah',
    difficulty: 'advanced',
    duration_weeks: 26,
  ...
  },
  {
    ...
    description:
      "Detailed chronological study of Prophet Muhammad's (ﷺ) life, battles, treaties, and lessons for modern Muslims.",
    age_tier: 'adults',
    subject: 'seerah',
    difficulty: 'intermediate',
    duration_weeks: 36,
  ...
  },
  {
    ...
    description:
      'Study of Islamic morality, character development, and practical application of prophetic manners in daily life.',
    age_tier: 'adults',
    subject: 'akhlaq',
    difficulty: 'beginner',
    duration_weeks: 16,
  ...
  },
  {
    ...
    description:
      'Detailed explanation of the 30th Juz of the Quran with historical context, linguistic analysis, and practical application.',
    age_tier: 'adults',
    subject: 'quran',
    difficulty: 'advanced',
    duration_weeks: 28,
  ...
  },
  {
    ...
    description:
      'Gentle-paced Quran study designed for seniors, focusing on reflection, memorization, and spiritual connection.',
    age_tier: 'seniors',
    subject: 'quran',
    difficulty: 'beginner',
    duration_weeks: 40,
  ...
  },
  {
    ...
    description:
      'Journey through Islamic history from the early Caliphate to modern times, understanding key events and personalities.',
    age_tier: 'seniors',
    subject: 'seerah',
    difficulty: 'beginner',
    duration_weeks: 32,
  ...
  },
  {
    ...
    description:
      'Essential Islamic rulings for everyday situations, covering family, business, and social interactions.',
    age_tier: 'adults',
    subject: 'fiqh',
    difficulty: 'beginner',
    duration_weeks: 18,
