/**
 * SQL-based Course Seeder
 * Creates 15 Islamic education courses directly via PostgreSQL
 */
...
async function seedCourses() {
  console.log('🚀 Starting SQL-based course seeding...\n');
  ...
  try {
    ...
    for (const course of courses) {
      try {
        ...
        await client.query(
          `INSERT INTO courses (
            title, slug, description, age_tier, subject, difficulty,
            duration_weeks, schedule, instructor, is_featured, learning_outcomes,
    ...
    console.log('🔗 Restart Strapi and visit http://localhost:1337/admin to manage courses\n');
